            ...
            Using Connection As MySqlConnection = New MySqlConnection(ConnectionString)
                ...
                Using sqlCommand As New MySqlCommand(sqlString.ToString(), Connection)
                    Try
                        ...
                        For Each a As KeyValuePair(Of Integer, String) In args
		...
		Public Function [Select](sql As String, ParamArray args As Object()) As SQLResult
            ...
            Using Connection As MySqlConnection = New MySqlConnection(ConnectionString)
                ...
                Try
                    ...
                    Using SqlData As IDataReader = sqlCommand.ExecuteReader(CommandBehavior.[Default])
                        Using retData As SQLResult = New SQLResult()
